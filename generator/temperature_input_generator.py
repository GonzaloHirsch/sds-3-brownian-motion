...
def main():
    ...
    points, ke = generate_points(int(args.area_length), int(args.particle_number), float(args.small_radius), float(args.small_mass), float(args.big_radius), float(args.big_mass), float(args.velocity_mod_limit), int(args.retry_count))
