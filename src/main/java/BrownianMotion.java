...
public class BrownianMotion {
    ...
    private void updateCollidedParticlesVelocity(CollisionInformation information) {
        if (information.firstParticleId < 0 && information.secondParticleId >= 0){
            this.particles.get(information.secondParticleId).calculateWallCollisionVelocity(information.firstParticleId);
        } else {
            this.particles.get(information.firstParticleId).calculateParticleCollisionVelocity(this.particles.get(information.secondParticleId));
        }
    }
